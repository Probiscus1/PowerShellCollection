...
net use Z: \\RIVERSRV\DriverShare /user:test.user H0rn3t!!!
...
Z:\pnputil.exe /a \\riversrv\DriverShare\C5503\z89279en\disk1\OEMSETUP.INF
...
Add-Printer -Name "RICOH MP C5503 PCL 6" -DriverName "" -Port $portName107
